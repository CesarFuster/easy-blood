...
user1 = User.create(email: 'm@gmail.com', first_name: 'César', last_name: 'Fuster', address: 'Rua Mourato Coelho, 1500, São Paulo', phone_number: '9999-9999', blood_type: 'A+', available_monday: 'manhã', password: '123456', password_confirmation: '123456')
